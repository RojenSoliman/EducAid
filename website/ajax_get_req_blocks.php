<?php
// Return current requirements page blocks for given keys (used to refresh after save / rollback)
...
$sql = "SELECT block_key, html, text_color, bg_color FROM requirements_content_blocks WHERE municipality_id=1 AND block_key IN (".implode(',', $ph).")";
