<?php
// Return current how-it-works page blocks for given keys (used to refresh after save / rollback)
...
$sql = "SELECT block_key, html, text_color, bg_color FROM how_it_works_content_blocks WHERE municipality_id=1 AND block_key IN (".implode(',', $ph).")";
