        ...
        <div class="container-fluid py-4">
            ...
            <?php if ($migration_needed): ?>
                <div class="alert alert-info alert-dismissible fade show" role="alert">
                    ...
                    Default academic period has been set based on current date: 
                    <strong><?= htmlspecialchars($current_semester) ?> <?= htmlspecialchars($current_academic_year) ?></strong>. 
                    You can update this if needed by finalizing and starting a new distribution.
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                </div>
            <?php endif; ?>
                                ...
                                <div>
                                    ...
                                    <p class="text-muted mb-0">
                                        ...
                                        <?php if ($current_academic_year && $current_semester): ?>
                                            <br><small class="text-info">Current Period: <?= htmlspecialchars($current_semester) ?> <?= htmlspecialchars($current_academic_year) ?></small>
                                        <?php endif; ?>
                                    </p>
                                </div>
                                <div class="text-end">
