...
$pageTitle = "Automatic Student Archiving";
?>
<?php $page_title='Automatic Student Archiving'; include '../../includes/admin/admin_head.php'; ?>
<style>
    .stat-card {
        text-align: center;
        padding: 20px;
                ...
                <div class="d-flex justify-content-between align-items-center mb-4">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Automatic Archiving</li>
                        </ol>
                    </nav>
                </div>
