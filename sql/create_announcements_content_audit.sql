-- Audit log for announcements page inline edits
CREATE TABLE IF NOT EXISTS announcements_content_audit (
...
CREATE INDEX IF NOT EXISTS idx_announcements_content_audit_muni_key ON announcements_content_audit (municipality_id, block_key);
