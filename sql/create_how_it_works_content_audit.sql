-- Audit log for how-it-works page inline edits
CREATE TABLE IF NOT EXISTS how_it_works_content_audit (
...
CREATE INDEX IF NOT EXISTS idx_how_it_works_content_audit_muni_key ON how_it_works_content_audit (municipality_id, block_key);
