-- Audit log for requirements page inline edits
CREATE TABLE IF NOT EXISTS requirements_content_audit (
...
CREATE INDEX IF NOT EXISTS idx_requirements_content_audit_muni_key ON requirements_content_audit (municipality_id, block_key);
