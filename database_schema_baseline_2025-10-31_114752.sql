...
BEGIN
    ...
    IF NEW.course IS NOT NULL AND NEW.first_registered_academic_year IS NOT NULL THEN
        ...
        IF program_duration IS NOT NULL THEN
            ...
            NEW.expected_graduation_year := registration_year + program_duration;
        END IF;
    END IF;
...
CREATE TRIGGER trigger_calculate_graduation_year BEFORE INSERT OR UPDATE OF course, first_registered_academic_year ON public.students FOR EACH ROW EXECUTE FUNCTION public.calculate_expected_graduation_year();
